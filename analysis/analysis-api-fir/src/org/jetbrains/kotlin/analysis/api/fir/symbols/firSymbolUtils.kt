...
internal fun FirVariableSymbol<*>.getKtConstantInitializer(useSiteSession: FirSession): KtConstantValue? {
    ensureResolved(FirResolvePhase.BODY_RESOLVE)
    val firInitializer = fir.initializer ?: return null
    return KtFirConstantValueConverter.toConstantValue(firInitializer, useSiteSession)
}
