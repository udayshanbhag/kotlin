...
internal fun parseDouble(string: String): Double {
    ...
    if (string == "NaN") return Double.NaN
    if (string == "Infinity") return Double.POSITIVE_INFINITY
    if (string == "-Infinity") return Double.NEGATIVE_INFINITY
...
//TODO This is partially implementation of parser. The issue with it is incorrect even rounding so the result number
//TODO could slightly different from other backends. True implementation needs Big Integer
//TODO Original implementation https://github.com/mono/corert/blob/master/src/System.Private.CoreLib/src/System/Number.CoreRT.cs
private fun numberToDouble(signed: Boolean, numberScale: Int, number: String): Double {
    var srcIndex = 0
